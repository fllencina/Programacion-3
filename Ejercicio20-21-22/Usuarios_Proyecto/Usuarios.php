...
include_once "AccesoDatos.php";
	...
	class Usuario
	{
		...
		{
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select nombre,apellido,mail,clave,fecha_de_registro,localidad from usuario");
			$consulta->execute();			
		...
		{
			$table="<table><thead><tr><th>Nombre y Apellido</th><th>Email</th><th>Clave</th><th>Localidad</th><th>Fecha de registro</th></tr></thead><tbody>";
			foreach($resultado as $fila)
    		{
          		$table.="<tr>";
          		$table.="<td>".$fila->nombre ." ".$fila->apellido."</td>";
